...
class API extends events.EventEmitter {
	...
	declareRepository(configuration) {
		...
		console.log('declareRepository::', {requirePath})
	...
	loadConfiguration(path) {
		...
		var contentProviders = [].concat(this.configuration.contentProviders);
		console.log('api::loadConfiguration', {path, contentProviders})
	...
	_processRequest(request, response) {
		...
		try {
			...
			console.log(this.upnpServer.processRequest.toString())
